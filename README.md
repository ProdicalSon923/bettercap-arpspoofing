...
![Interface Identification](screenshots/02-interface.png)
...
![Bettercap Launch](screenshots/03-bettercap-launch.png)
...
![Network Reconnaissance](screenshots/04-network-recon.png)
...
![Target Identification](screenshots/05-target-selection.png)
...
![ARP Spoofing](screenshots/06-arp-spoof.png)
...
![Traffic Interception](screenshots/07-traffic-capture.png)
...
![Intercepted Traffic](screenshots/08-intercepted-data.png)
